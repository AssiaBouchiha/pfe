...
public class SeroType   extends AuditBusinessObject     {
    ...
    public SeroType(Long id,String libelle){
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        SeroType seroType = (SeroType) o;
        return id != null && id.equals(seroType.id);
    }
