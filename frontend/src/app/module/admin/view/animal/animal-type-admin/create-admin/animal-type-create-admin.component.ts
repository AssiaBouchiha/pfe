...
@Component({
  selector: 'app-animal-type-create-admin',
  templateUrl: './animal-type-create-admin.component.html'
})
export class AnimalTypeCreateAdminComponent extends AbstractCreateController<AnimalTypeDto, AnimalTypeCriteria, AnimalTypeService>  implements OnInit {
