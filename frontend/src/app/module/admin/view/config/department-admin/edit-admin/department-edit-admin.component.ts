...
@Component({
  selector: 'app-department-edit-admin',
  templateUrl: './department-edit-admin.component.html'
})
export class DepartmentEditAdminComponent extends AbstractEditController<DepartmentDto, DepartmentCriteria, DepartmentService>   implements OnInit {
