...
@Component({
  selector: 'app-age-category-create-admin',
  templateUrl: './age-category-create-admin.component.html'
})
export class AgeCategoryCreateAdminComponent extends AbstractCreateController<AgeCategoryDto, AgeCategoryCriteria, AgeCategoryService>  implements OnInit {
