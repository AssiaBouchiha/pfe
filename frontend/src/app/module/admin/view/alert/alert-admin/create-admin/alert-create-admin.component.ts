...
@Component({
  selector: 'app-alert-create-admin',
  templateUrl: './alert-create-admin.component.html'
})
export class AlertCreateAdminComponent extends AbstractCreateController<AlertDto, AlertCriteria, AlertService>  implements OnInit {
