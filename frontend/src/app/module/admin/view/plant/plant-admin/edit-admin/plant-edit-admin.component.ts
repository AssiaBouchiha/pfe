...
@Component({
  selector: 'app-plant-edit-admin',
  templateUrl: './plant-edit-admin.component.html'
})
export class PlantEditAdminComponent extends AbstractEditController<PlantDto, PlantCriteria, PlantService>   implements OnInit {
    ...
    public prepareEdit() {
        this.item.dateofbirth = this.plantService.format(this.item.dateofbirth);
    }
