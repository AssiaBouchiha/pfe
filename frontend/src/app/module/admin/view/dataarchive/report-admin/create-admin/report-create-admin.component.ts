...
@Component({
  selector: 'app-report-create-admin',
  templateUrl: './report-create-admin.component.html'
})
export class ReportCreateAdminComponent extends AbstractCreateController<ReportDto, ReportCriteria, ReportService>  implements OnInit {
