...
@Component({
  selector: 'app-data-archive-create-admin',
  templateUrl: './data-archive-create-admin.component.html'
})
export class DataArchiveCreateAdminComponent extends AbstractCreateController<DataArchiveDto, DataArchiveCriteria, DataArchiveService>  implements OnInit {
