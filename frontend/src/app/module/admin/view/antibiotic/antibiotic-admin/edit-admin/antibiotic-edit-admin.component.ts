...
@Component({
  selector: 'app-antibiotic-edit-admin',
  templateUrl: './antibiotic-edit-admin.component.html'
})
export class AntibioticEditAdminComponent extends AbstractEditController<AntibioticDto, AntibioticCriteria, AntibioticService>   implements OnInit {
