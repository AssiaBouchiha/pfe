...
@Component({
  selector: 'app-reason-create-admin',
  templateUrl: './reason-create-admin.component.html'
})
export class ReasonCreateAdminComponent extends AbstractCreateController<ReasonDto, ReasonCriteria, ReasonService>  implements OnInit {
