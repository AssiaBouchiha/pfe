...
@Component({
  selector: 'app-data-import-export-edit-admin',
  templateUrl: './data-import-export-edit-admin.component.html'
})
export class DataImportExportEditAdminComponent extends AbstractEditController<DataImportExportDto, DataImportExportCriteria, DataImportExportService>   implements OnInit {
