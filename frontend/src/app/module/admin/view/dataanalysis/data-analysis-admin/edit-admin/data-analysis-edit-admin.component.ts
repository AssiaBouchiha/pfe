...
@Component({
  selector: 'app-data-analysis-edit-admin',
  templateUrl: './data-analysis-edit-admin.component.html'
})
export class DataAnalysisEditAdminComponent extends AbstractEditController<DataAnalysisDto, DataAnalysisCriteria, DataAnalysisService>   implements OnInit {
