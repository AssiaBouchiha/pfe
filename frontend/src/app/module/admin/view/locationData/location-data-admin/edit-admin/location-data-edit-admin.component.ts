...
@Component({
  selector: 'app-location-data-edit-admin',
  templateUrl: './location-data-edit-admin.component.html'
})
export class LocationDataEditAdminComponent extends AbstractEditController<LocationDataDto, LocationDataCriteria, LocationDataService>   implements OnInit {
